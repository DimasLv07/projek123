...
@section('content')
    <div class="signup-container">
        ...
        <p class="text-[16px] font-[400] ops w-[385.5px] mb-[35px]">If you dont have an account, you can <span
        ...
        <div class="relative mt-[7px] mb-[38px]">
            ...
            <input
                class="placeholder-black form-input w-full	py-2 text-sm text-black bg-white text-[16px] font-[400] ops pl-10 "
        ...
        <div class="mb-[13px] text-center text-[17px] text-white font-[600] ops py-[12px] bg-[#FF7E00] rounded-[32px]">
            Sign In
        </div>
