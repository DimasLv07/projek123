...
@section('content')
    <div>
        <div class="landingpage-container">
            <div class="flex justify-between mb-[85px]">
                <div class="w-[350px]">
                ...
                <img class="w-[256px] h-[256px]" src="{{ asset('images/landing-page-first.png') }}" alt="">
            </div>
        ...
        <div class="bg-[#FF7E00] mb-[40px]">
            <div class="landingpage-container">
                ...
                <div class="grid grid-cols-4 gap-4 mt-[22px] justify-items-center pb-[56px]">
        ...
        <div class="landingpage-container mt-[0px]">
            ...
            <div class="flex mx-[20px]">
                <div class="bg-black w-[513px] h-[202px] mr-[12px]">

                </div>
                <div class="bg-black w-[513px] h-[202px] ml-[12px]">
            ...
            <div class="flex">
                <div class="w-[347px] h-[214px] mr-[24px] bg-black">

                </div>
                <div class="w-[347px] h-[214px] mr-[24px] bg-black">

                </div>
                <div class="w-[347px] h-[214px] bg-black">
        ...
        <div class="bg-[#FF7E00] mb-[40px]">
            <div class="landingpage-container mt-[96px]">
                ...
                <div class="grid grid-cols-6 gap-6 mt-[22px] justify-items-center pb-[56px]">
                    <div class="w-[162px] h-[74px] bg-black rounded-[4px]">
